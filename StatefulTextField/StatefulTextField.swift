...
public class StatefulTextField: UITextField {
  ...
  var shouldColorChangeForState: Bool = true  // If a textField is optional, set this to false when setting properties
...
//    UITextField.textDidBeginEditingNotification
  ...
  @IBInspectable open var fontSize: CGFloat = 15.0 {
    didSet {
//      self.font = UIFont(name: UIFont.Monsterrat.light.name, size: fontSize)
  ...
  // You cant unpack an array into variadic arguments in swift yet, so the duplicated method signature is required as of right now.
